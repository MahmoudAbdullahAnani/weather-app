...
function VisibilityWind({
  ...
  // {visibility} {windSpeed} {windDeg} {windGust}
  return (
    <div className="flex justify-start align-items-center gap-x-5   mt-3   flex-wrap">
      <div className="text-white flex align-items-center gap-2 flex-nowrap m-0">
        ...
        <b>Wind </b>
        <span className='fs-4'>{Math.round(visibility / 1000)}.0 KM</span>
      </div>
      ...
      <div className="text-white flex align-items-center  flex-nowrap">
        ...
        <span className="fs-4">{windSpeed} km/h</span>
      </div>
      <div className="text-white flex align-items-center  flex-nowrap">
        <span className="fs-2 me-4">||</span>
        <span className="me-1">
        ...
        <span className="fs-4">{windDeg} km/h</span>
      </div>
      <div className="text-white flex align-items-center  flex-nowrap">
        <span className="fs-2 me-4">||</span>
        <span className="me-1">
        ...
        <span className="fs-4">{windGust} km/h</span>
      </div>
    </div>
  );
}

export default VisibilityWind